                    ...
                    <div class="col-md-3">
                        <div class="card pl-3 pr-3">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <p>
                                        IoT allows users to remotely monitor and control anywhere and anytime through
                                        internet using the official website and mobile applications that
                                        we have provided.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <p>
                                        ...
                                        algorithm that allow user to know weather, crop recommendation, also pests prediction .
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div style="display: flex;">
                                ...
                                <div style="margin-left: 20px;">
                                    <p>
                                        Arnesys is equipped with technology in the form of AI with the Fuzzy and XGBoost methods to make predictions.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row mt-3">
                <div class="col-md-4" style="display: flex; flex-direction: column; justify-content: space-between;">
                    <div class="member-item" data-id="1">
                        <h4>Maisevli Harika, M.T.,M.Eng.</h4>
                    ...
                    <div class="member-item" data-id="4">
                        ...
                        <p style="margin-top: -5px;">Researcher and Agricultural Expertise</p>
                    </div>
                    ...
                    <div class="member-item" data-id="6">
                        <h4>Raden Allysha Rizkyta Aprillya</h4>
                        <p style="margin-top: -5px;">Chief Financial Officer</p>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="row">
                            ...
                            <div class="gallery">
                                ...
                                <figure id="figure-item" class="gallery__item" data-id="2">
                                    <img src="{{ asset('assets') }}/landing-page/images/indra2.png"
                                        style="object-position: 0% 50%;" class="gallery__img" alt="Image 2">
                                </figure>
