...
@section('breadcrumb-content')
  <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder text-white mb-0">Monitoring</h6>
    </nav>
@endsection
...
@section('content')
  <div class="row content-wrapper mt-3">
    ...
    <div class="modal fade" id="feedbackModal" tabindex="-1" role="dialog" aria-labelledby="modalSayaLabel" aria-hidden="true">
